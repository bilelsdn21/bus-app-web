...
export const DOT = {
  green:  { bg: "bg-emerald-500", ring: "bg-emerald-100", label: "Réservé (multi-jours / plusieurs périodes)", emoji: "🟢" },
  ...
  blue:   { bg: "bg-sky-500",     ring: "bg-sky-100",     label: "Occupé (sans horaire)", emoji: "🔵" },
